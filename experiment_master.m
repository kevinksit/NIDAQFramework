...
% given rpm , how many steps per second? then how many steps per 10th second?
% this way we know how much it's moved
% from there we can calculate the position from a start point